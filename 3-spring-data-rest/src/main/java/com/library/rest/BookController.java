...
public class BookController {
    ...
    @RequestMapping(value ="/{id}/checkout", method = RequestMethod.POST, consumes = {"text/uri-list"})
    public ResponseEntity<Void> checkout(@PathVariable("id") Book book, @RequestBody Member member) {
